...
std::optional<ConversationType> conversationTypeFromString(const QString &type) {
    static const QHash<QString, ConversationType> kMap{{"dm", ConversationType::Dm},
...
std::optional<ContentKind> contentKindFromString(const QString &kind) {
    static const QHash<QString, ContentKind> kMap{{"text", ContentKind::Text},
                                                  {"attachment", ContentKind::Attachment},
