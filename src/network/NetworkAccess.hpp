...
public:
  ...
  NetworkResponse get(const QString &path, const QUrlQuery &query = {}, const HeaderMap &headers = {}) const;
  ...
  NetworkResponse deleteRequest(const QString &path, const QUrlQuery &query = {}, const HeaderMap &headers = {}) const;
