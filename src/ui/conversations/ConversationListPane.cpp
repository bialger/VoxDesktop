...
ConversationListPane::ConversationListPane(QWidget *parent) : QWidget(parent) {
    ...
    connect(m_searchEdit, &QLineEdit::textChanged, this, [proxy](const QString &text) {
        proxy->setFilterRegularExpression(QRegularExpression(QRegularExpression::escape(text),
    ...
    connect(dmAction, &QAction::triggered, this, [this]() {
        ...
        const QString username =
            QInputDialog::getText(this, "New DM", "Username:", QLineEdit::Normal, {}, &ok).trimmed();
    ...
    connect(groupAction, &QAction::triggered, this, [this]() {
        bool ok = false;
        const QString raw = QInputDialog::getMultiLineText(this,
                                                          "New Group",
    ...
    connect(channelAction, &QAction::triggered, this, [this]() {
        ...
        const QString raw = QInputDialog::getMultiLineText(this,
                                                          "New Channel",
                                                          "Admin usernames (optional; comma/newline separated):",
                                                          {},
                                                          &ok)
                                .trimmed();
        if (!ok) {
    ...
    connect(m_listView, &QListView::clicked, this, [this](const QModelIndex &proxyIndex) {
        ...
        const QString conversationId =
            sourceIndex.data(ConversationListModel::ConversationIdRole).toString();
