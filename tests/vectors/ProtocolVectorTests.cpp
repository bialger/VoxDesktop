...
TEST_F(ProjectVectorTestSuite, DoubleRatchetRoundTripVector) {
    const QByteArray sharedSecret = QByteArray::fromHex("00112233445566778899aabbccddeeff00112233445566778899aabbccddeeff");
...
TEST_F(ProjectVectorTestSuite, SyncWrapUnwrapVector) {
    ...
    const QByteArray syncMasterKey = QByteArray::fromHex("11223344556677889900aabbccddeeff00112233445566778899aabbccddeeff");
